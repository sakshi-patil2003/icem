...
<div className="font-baskerville-regualr">
    ...
    <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-6">
      ...
      <div className="space-y-6">
        <div className="flex flex-col justify-between h-full">
          ...
          {/* Rest of the Content (50% Height) */}
          <div className="text-sm space-y-6" style={{ height: "50%" }}>
  ...
  {/* Copyright Section */}
  <div className="bg-[#023b5e] py-4 mt-2 px-8 md:px-16 text-left text-white text-sm ">
