    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-center space-x-20 mx-auto">
          {/* Step 1 */}
           <div className="relative bg-white text-[#ffffff] p-6 shadow-xl  w-48"
          style={{ backgroundColor: "rgba(139, 197, 255, 0.5)" }}>
            <div className="absolute top-[-15px] left-[-15px] bg-[#6095ff] text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg"
...
>
          ...
          {/* Step 5 */}
          <div className="relative bg-white   p-6 shadow-xl  w-48"
          style={{ backgroundColor: "rgba(139, 197, 255, 0.5)" }}>
            <div className="absolute top-[-15px] left-[-15px] bg-[#6095ff] text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg"
          style={{ backgroundColor: "rgba(0, 102, 204, 0.9)" }}
>
