...
import forkliftImage from "../../assets/images/forklift.png"; // Adjust the path to your forklift image
...
const MechForklift = () => {
  ...
  return (
    <div className="absolute bottom-[-4rem] left-0 z-20">
      <img
        src={forkliftImage}
        alt="Forklift"
        className="forklift w-1/6" // You can adjust the size as needed
      />
    </div>
  );
};
